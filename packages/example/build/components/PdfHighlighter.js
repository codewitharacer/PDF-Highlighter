...
class PdfHighlighter extends PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, 'renderTip', () => {
      ...
      if (highlightLayer) {
        ReactDom.render(
          /*#__PURE__*/ React.createElement(
            'div',
            null,
            (highlightsByPage[String(pageNumber)] || []).map(({ position, id, ...highlight }, index) => {
  ...
  render() {
    const { onSelectionFinished, enableAreaSelection, closeTooltip } = this.props;
    return /*#__PURE__*/ React.createElement(
      Pointable,
      {
